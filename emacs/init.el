...
(custom-set-variables
 ...
 '(package-selected-packages
   '(editorconfig lsp-tailwindcss lsp-ui csharp-mode rainbow-mode dap-mode lsp-mode pyenv-mode xterm-color yaml-mode irony ivy elpy fzf ripgrep json-mode add-node-modules-path prettier-js flycheck web-mode tide tidal latex-preview-pane graphql-mode graphql go-guru exec-path-from-shell centered-cursor-mode ag))
